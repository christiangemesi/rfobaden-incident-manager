...
describe('UiDateLabel', () => {
  ...
  it('should render the date and time of both dates if configured to do so', () => {
    ...
    expect(html.html()).toBe('von 09.11.2012 10:20 bis 02.02.2013 08:12')
  })
})
