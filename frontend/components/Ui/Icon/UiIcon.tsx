...
/**
 * `UiIcon` is a component that displays an icon.
 */
...
/**
 * Create a named icon for a specific path with its default props.
 *
 * @param path The path of the icon.
 * @param defaultProps The default props of the icon.
...
// Svg paths for the priority icons.
